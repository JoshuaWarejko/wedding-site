  ...
  const households = [
    {
      ...
      head: "Joshua",
      guests: [
        { firstName: "Joshua", lastName: "Warejko" },
        { firstName: "Haley", lastName: "Warejko" }
      ]
    },
    {
      name: "Goins",
      head: "Marshall",
      guests: [
        { firstName: "Marshall", lastName: "Goins" },
        { firstName: "Carrie", lastName: "Goins" }
      ]
    },
    {
      name: "Horsager",
    ...
    },
    {
      name: "Horsager",
      head: "Zack",
      guests: [{ firstName: "Zack", lastName: "Horsager" }]
    },
    {
      name: "Lee",
      head: "Heidi",
      guests: [{ firstName: "Heidi", lastName: "Lee" }]
    },
    {
      name: "Chavez",
      head: "Angel",
    ...
    },
    {
      name: "Horsager",
      head: "Julene",
      guests: [{ firstName: "Julene", lastName: "Horsager" }]
    },
    {
      name: "Warejko",
      head: "Jeff",
    ...
    },
    {
      name: "Ganish",
      head: "Gilad",
      guests: [{ firstName: "Gilad", lastName: "Ganish" }]
    },
    {
      name: "Banks",
      head: "Sean",
    ...
    },
    {
      name: "Hollister",
      head: "Mackenzie",
      guests: [{ firstName: "Mackenzie", lastName: "Hollister" }]
    },
    {
      name: "Hanna",
      head: "Morgan",
      guests: [{ firstName: "Morgan", lastName: "Hanna" }]
    },
    {
      name: "Hamada",
      head: "Elizabeth",
      guests: [{ firstName: "Elizabeth", lastName: "Hamada" }]
    },
    {
      name: "Ricci",
      head: "Diane",
    ...
    },
    {
      name: "Shaw",
      head: "Elliott",
      guests: [{ firstName: "Elliott", lastName: "Shaw" }]
    },
    {
      name: "Stockdale",
      head: "Geneva",
      guests: [{ firstName: "Geneva", lastName: "Stockdale" }]
    },
    {
      name: "Kerins",
      head: "Mary Lou",
      guests: [{ firstName: "Mary Lou", lastName: "Kerins" }]
    },
    {
      name: "Ercoli",
      head: "Robert",
      guests: [{ firstName: "Robert", lastName: "Ercoli" }]
    },
    {
      name: "Verstegen",
      head: "Jonathan",
    ...
    },
    {
      name: "Revetta",
      head: "Elise",
      guests: [{ firstName: "Elise", lastName: "Revetta" }]
    },
    {
      name: "Hawkins",
      head: "Brandon",
      guests: [{ firstName: "Brandon", lastName: "Hawkins" }]
    },
    {
      name: "Nelson",
      head: "Jesse",
      guests: [{ firstName: "Jesse", lastName: "Nelson" }]
    },
    {
      name: "Donovan",
      head: "Emily",
      guests: [{ firstName: "Emily", lastName: "Donovan" }]
    },
    {
      name: "Hardaway",
      head: "Dante",
    ...
    },
    {
      name: "Priestly",
      head: "Ashley",
      guests: [{ firstName: "Ashley", lastName: "Priestley" }]
    },
    {
      name: "Cheikha",
      head: "Fadi",
    ...
    },
    {
      name: "Verstegen",
      head: "Stephen",
      guests: [{ firstName: "Stephen", lastName: "Verstegen" }]
    },
    {
      name: "Yang",
      head: "Mason",
      guests: [{ firstName: "Mason", lastName: "Yang" }]
    },
    {
      name: "Bonstrom",
      head: "James",
      guests: [{ firstName: "James", lastName: "Bonstrom" }]
    },
    {
      name: "Self",
      head: "Sue",
    ...
    },
    {
      name: "Forstel",
      head: "Hannah",
      guests: [{ firstName: "Hannah", lastName: "Forstel" }]
    },
    {
      name: "Madden",
      head: "Taylor",
    ...
    },
    {
      name: "Cortez",
      head: "Chris",
      guests: [{ firstName: "Chris", lastName: "Cortez" }]
    },
    {
      name: "Salazar",
      head: "Santiago",
      guests: [{ firstName: "Santiago", lastName: "Salazar" }]
    }
  ];

  async.each(
    households,
    (householdData, callback) => {
      async.waterfall(
        [
          callback => {
            // Check if matching household already exists, else create new household.
            Household.findOne(
              { where: { name: householdData.name, head: householdData.head } },
              (error, foundHousehold) => {
                if (error) return callback(error);
                if (foundHousehold) return callback(null, foundHousehold);
                return Household.create(
                  { name: householdData.name, head: householdData.head },
                  callback
                );
              }
            );
